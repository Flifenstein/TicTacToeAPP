...
public class Game extends View {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    ...
                    break;
                case 1:
                    Toast.makeText(getContext(), "Player 1 Wins! Cool game, dude", Toast.LENGTH_SHORT).show();
                    break;
                case 2:
                    Toast.makeText(getContext(), "Player 2 Wins! Wow, such game", Toast.LENGTH_SHORT).show();
                    break;
                case 3:
                    Toast.makeText(getContext(), "And the winner is...none of you!", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
    ...
    public void drawimage(int x_aux, int y_aux) {
        ...
        if (whatdrawn)
        {
            cel = new Plus(singlesquare[x_aux][y_aux].x,singlesquare[x_aux][y_aux].y);
            whatdrawn = false;
        }
        else
        {
